    ...
    public static void main(String[] args) {
        ...
        while (scam){
            ...
            if (board.containsKey(move)) {
                ...
                String numb = move.replaceAll(" ", "");
                if(numb.matches("[^a-zA-Z]")) {
